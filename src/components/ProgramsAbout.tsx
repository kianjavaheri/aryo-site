    ...
    <div id="programs-about">
      <div id="writing-section">
        ...
        <div className="info">
          ...
          <div className="grid uchicago">
            <div className="image-container uchicago">
        ...
        <div className="info">
          ...
          <div className="grid laspo-grid">
            ...
            <div  className="text-container laspo">
              <h3>Grade: A</h3>
              <p>As part of my education at Las Positas Community College, I took an introductory course in microeconomics. Through this course, I learned about all the fundamental principles of microeconomics, including supply and demand, market structures, and consumer and producer behavior. I gained an understanding of how these principles can be used to analyze and make informed decisions about issues such as pricing, resource allocation, and market efficiency. Overall, this course provided me with a strong foundation in microeconomic theory and the tools to analyze and understand economic phenomena at the level of individual households and firms.</p>
            </div>
          </div>
        </div>
